...
public class CitySelect2Activity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (ids[0] == v.getId()) {//���ͷ��ʡ�ݰ�ť
			current = 0;
			util.initProvince();
			tvs[last].setBackgroundColor(Color.WHITE);
			tvs[current].setBackgroundColor(Color.GRAY);
			last = current;
		} else if (ids[1] == v.getId()) {//���ͷ�����а�ť
			if (city.getProvinceCode() == null|| city.getProvinceCode().equals("")) {
				current = 0;
				Toast.makeText(CitySelect2Activity.this, "��û��ѡ��ʡ��",
			...
			if (city.getProvinceCode() == null
				...
				Toast.makeText(CitySelect2Activity.this, "��û��ѡ�����",
						Toast.LENGTH_SHORT).show();
				current = 1;
