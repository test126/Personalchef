...
public class CitySelect1Activity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.addr_activity_city2);
	...
	class CityAdapter extends ArrayAdapter<MyRegion> {
		...
		public View getView(int arg0, View v, ViewGroup arg2) {
			v = inflater.inflate(R.layout.addr_city_item, null);
	...
	public void onClick(View v) {
		...
		case R.id.btn_back:
			...
			break;
		case R.id.btn_right:
			if(tvs[0].getText().toString().trim().equals("省"))
			{
				Toast.makeText(CitySelect1Activity.this, "请先选择省份",
						Toast.LENGTH_SHORT).show();
				return;
			}else if(tvs[1].getText().toString().trim().equals("市")){
				Toast.makeText(CitySelect1Activity.this, "请先选择城市",
						Toast.LENGTH_SHORT).show();
				return;
			}else if(tvs[2].getText().toString().trim().equals("区/县")){
				Toast.makeText(CitySelect1Activity.this, "请先选择区/县",
						Toast.LENGTH_SHORT).show();
				return;
			}
		...
		if (ids[0] == v.getId()) {
			...
			if (city.getProvinceCode() == null
				...
				Toast.makeText(CitySelect1Activity.this, "请先选择省份和城市",
						Toast.LENGTH_SHORT).show();
				current = 0;
				util.initProvince();
				return;
